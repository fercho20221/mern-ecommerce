...
const prueba = (req, res) => {
    res.send({
        msg: "En esta ruta gestionaremos todas las peticiones correspondiente al modelo de Usuariosvv"
    })
};
...
const registrar = async (req, res)=>{
    ...
    if(existeUsuario){ const error = new Error("Usuario ya registrado"); return res.status(400).json({msg: error.message}); };
    
    try {
    
    //Busca en la colección de Usuario por email.
