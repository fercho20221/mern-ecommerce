        ...
        <div className='flex w-full'>
            ...
            <div className='flex flex-col justify-center items-center lg:w-2/4 mr-10 md:flex-row '>
                ...
                <div>
                    ...
                    <h1 className='font-bold text-6xl uppercase text-center md:w-2/3 mx-auto'>Registrate y disfruta de los <span className='text-sky-700'>productos</span></h1> <form className='p-4 mx-auto w-96 sm:px-9 mt-8 shadow-md'> <div className='mb-5'>

                        Registro.jsx

                        <label htmlFor="nombre" className='font-medium'>Nombre</label>

                        <input type="text" id="nombre" className='block placeholder-slate-400 p-2 w-full bg-slate-100' placeholder='ej: Juan David Ariza Torres' /> </div> <div className='mb-5'>
                            ...
                            <input type="text" id="direccion" className='block placeholder-slate-400 p-2 w-full bg-slate-100' placeholder='ej: Calle 12 #34-56' />

                        </div> <div className='mb-5'>

                            <label htmlFor="telefono" className='font-medium'>Telefono</label>

                            <input type="number" id="telefono" className='block placeholder-slate-400 p-2 w-full bg-slate-100' placeholder='ej: 300123456' />
                        ...
                        <div className='flex justify-between px-4 mt-5 text-slate-500 '>
                            ...
                            <Link to="/" className=''>Ya tengo cuentass.</Link>

                            <Link to="/olvide-password">Olvide mi password.</Link>

                            <Link to="/lista-carrito">Compra Zapatos.</Link>
